        ...
        private class PackageDefinition
        {
            ...
            public static List<PackageDefinition> CreateDefaults()
            {
                ...
                return new List<PackageDefinition>
                {
                    ...
                    new PackageDefinition("com.bumimobile.build", "Build", "Android pre-build confirmation, versioning, presets, and signing tools.", "Packages/com.bumimobile.build", defaultVersion, false, CoreDependency()),
