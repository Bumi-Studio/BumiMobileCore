...
namespace BumiMobile
{
    ...
    public class Particle
    {
        ...
        /// </summary>
    public SimplePrefabPool ParticlePool { get; private set; }
        ...
        public void Init()
        {
            ...
            ParticlePool = new SimplePrefabPool(particlePrefab, $"Particle_{ParticleName}_Pool");
        ...
        {
            ParticlePool?.Release(instance, true);
        }

        public void ReleaseAll()
        {
            ParticlePool?.ReleaseAll(true);
        }
    }
}