...
Quick start
1. Window: open Tools -> 🔐 Secret Keystore to create a keystore (secrets.keystore.bytes will be created under Assets/Resources)
...
Notes
- Keystore file path (editor): Assets/Resources/secrets.keystore.bytes
